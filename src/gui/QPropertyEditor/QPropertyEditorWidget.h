...
public:
	...
	/**
     * Similar to the addObject() but it will clear the model before.
	 */
...
private:
        ...
        QPropertyModel*  m_model;    // The Model for this view

        QObject* m_propertyObject;   // The object actually displayed
