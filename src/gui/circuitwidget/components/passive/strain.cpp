...
static const char* Strain_properties[] = {
    ...
    QT_TRANSLATE_NOOP("App::Property","Min Force N"),
    QT_TRANSLATE_NOOP("App::Property","Max Force N"),
    QT_TRANSLATE_NOOP("App::Property","Force N"),
    QT_TRANSLATE_NOOP("App::Property","Ref Temp"),
    QT_TRANSLATE_NOOP("App::Property","Temp")
};
