...
void ItemLibrary::loadItems()
{
    ...
    addItem( new LibraryItem( tr("Arduino"),tr("Micro"), "arduinoUnoIcon.png","", 0l ) );
    ...
    addItem( new LibraryItem( "IC 74",tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( "IC CD",tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( "USSR IC",tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( tr("Other IC"),tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( tr("Keys"),tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( tr("Ternary"),tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( tr("Tools"),tr("Logic"), "ic2.png","", 0l ) );
    addItem( new LibraryItem( tr("Led display"),tr("Logic"), "ic2.png","", 0l ) );
    // Subcircuits
    ...
    //addItem( new LibraryItem( tr("New Arduinos"),tr("Experimental"), "arduinoUnoIcon.png","", 0l ) );
    //addItem( new LibraryItem( tr("Shields"),tr("Experimental"), "shield.png","", 0l ) );
    //addItem( new LibraryItem( tr("Tools"),tr("Experimental"), "subc.png","", 0l ) );
}
...
LibraryItem* ItemLibrary::getItem( const QString type ) const
{
    for( LibraryItem* item : m_items )
    {
