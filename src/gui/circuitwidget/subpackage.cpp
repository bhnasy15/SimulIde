...
static const char* SubPackage_properties[] = {
    ...
    QT_TRANSLATE_NOOP("App::Property","Background"),
    QT_TRANSLATE_NOOP("App::Property","SubcType")
};
...
{
    /// CircuitView::self()->viewport()->setCursor( Qt::WhatsThisCursor );
...
void SubPackage::savePackage( QString fileName )
{
    ...
    QString shield = metaEnum.valueToKey( m_subcType );
