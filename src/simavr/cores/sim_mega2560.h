...
const struct mcu_t {
    ...
    .timer2 = {
        .name = '2',
        .wgm = { AVR_IO_REGBIT( TCCR2A, WGM20 )
               , AVR_IO_REGBIT( TCCR2A, WGM21 )
               , AVR_IO_REGBIT( TCCR2B, WGM22 ) },
        .wgm_op = {
            [0] = WGM_NORMAL8(),
            [1] = WGM_FCPWM_8(),
            [2] = WGM_CTC_OC(),
    ...
    .timer5 = {
        ...
        .wgm = { AVR_IO_REGBIT( TCCR5A, WGM50 )
               , AVR_IO_REGBIT( TCCR5A, WGM51 )
               , AVR_IO_REGBIT( TCCR5B, WGM52 )
               , AVR_IO_REGBIT( TCCR5B, WGM53 ) },
        .wgm_op = {
             [0]  = WGM_NORMAL16(),
             [1]  = WGM_FCPWM_8(),
             [2]  = WGM_FCPWM_9(),
